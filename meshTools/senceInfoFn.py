...
def copy_del_uvSets(objList = cmds.ls(sl =1)):
    '''
    copy_del_uvSets(objList = cmds.ls(sl =1),sourceUVSets = 'uv')
    :param objList:
    :param sourceUVSets:
    :return:
    '''
    ...
    for mesh in objList:
        ...
        for uv_set in uv_sets:
            if uv_set != "map1":
                # 将非map1的UV Set拷贝到map1
                cmds.polyUVSet(mesh, copy=True, uvSet=uv_set, newUVSet="map1")
                # 删除原有的UV Set
